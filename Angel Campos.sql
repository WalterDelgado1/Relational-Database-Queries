--01 Devuelve el Nombre y Paellido del administrador de cada hotel--
...
--02 Funcion que retorna el nombre del hotel admin segun el ID de una reserva.
...
--03 Funcion que retorna el nombre del usuario segun el id de la cancelacion
